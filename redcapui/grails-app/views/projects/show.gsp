...
<html>
    ...
    <body>
    	<g:render template="/layouts/navigationbar" model="['page':'projects/show']" />
    	<!-- 
        <div class="nav">
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="projects.id.label" default="Id" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="projects.projectID.label" default="Project ID" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: projectsInstance, field: "projectID")}</td>
